...
class TouchScreen(pykka.ThreadingActor, core.CoreListener):
    ...
    def __init__(self, config, core):
        ...
        print("The Framebuffer size: ", size[0], "x", size[1])
        ...
        # Raspberry pi GPIO
        print("GPIO ", config['touchscreen']['gpio'])
        self.gpio = config['touchscreen']['gpio']
        if self.gpio:

            pins = {}
            # print("Up: ", config['touchscreen']['gpio_up'])
            # print("Down: ", config['touchscreen']['gpio_down'])
            # print("Enter: ", config['touchscreen']['gpio_enter'])
